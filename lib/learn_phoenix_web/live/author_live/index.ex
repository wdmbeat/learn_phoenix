defmodule LearnPhoenixWeb.AuthorLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :authors, Library.list_authors())}
  end
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:author, Library.get_author!(id))
  end
  ...
  @impl true
  def handle_info({LearnPhoenixWeb.AuthorLive.FormComponent, {:saved, author}}, socket) do
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    {:ok, _} = Library.delete_author(author)
