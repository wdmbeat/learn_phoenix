defmodule LearnPhoenixWeb.BookLiveTest do
  use LearnPhoenixWeb.ConnCase

  import Phoenix.LiveViewTest
  import LearnPhoenix.LibraryFixtures

  @create_attrs %{title: "some title", price: "120.5", publication_date: "2025-01-04T00:54:00Z"}
  @update_attrs %{title: "some updated title", price: "456.7", publication_date: "2025-01-05T00:54:00Z"}
